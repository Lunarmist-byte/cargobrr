...
def main():
    ...
    while running:
        ...
        draw_text(screen, "CARGOBRR CUDA", 20, 20, 26, ACCENT_CYAN)
        draw_text(screen, f"ENG: {cfg.engine_type} | ASP: {cfg.aspiration} | TRN: {cfg.transmission}", 20, 55, 14, (160, 160, 160))
        draw_text(screen, "GPU THREADS: 10,000", 20, 75, 12, ACCENT_ORANGE)
